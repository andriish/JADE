C   23/06/78 704052128  MEMBER NAME  CERNKV67 (S)           FORTRAN
...
C     TOTAL REFLECTION FOR N=1.805      5.4.87   J.OLSSON
C
...
C-----  TOTAL REFLECTION CHECK IS CHANGED. 02-12-77
  ...
  600   FORMAT('0******** TRANSPARENCY CHECK AT THE SF6/PM BOUNDARY',
C 600   FORMAT('0******** TRANSPARENCY CHECK AT THE SF6/PM BOUNDARY',
     1  /' ',20X,'CHANGED 05-04-87   ********')
        MESS = 1
C       IF(ABSANN.LT.0.4172) GO TO 1
C       TRNS = 1.-0.0065/(ABSANN-0.410)
C  N=1.805 FOR SF6, N=1.52 FOR PM GLASS ASSUMED
        IF(ABSANN.LT.0.5393) GO TO 1
        TRNS = 1.-0.0065/(ABSANN-0.5327)
