...
C
        CALL CORE(HWORK,80)
        WRITE(10,320) INAMV,NBKV,NTRVEC
...
C
      CALL CORE(HWORK,80)
      WRITE(10,221) ICNT,JPARTN,XFN,YFN,TAGFI
221   FORMAT(I2,1X,I2,1X,F7.2,2X,F7.2,2X,F5.1)
      CALL SYSSYM(XXX,YYY,SSS,HWORK,29,0.)
      YYY = YYY - 1.5*SSS
      COSTH = COS(THE)
      CALL CORE(HWORK,80)
      WRITE(10,222) EFN,DEFN,COSTH
