...
C---
  ...
  123 FORMAT('ARRAY         IRN. ALL VALUES=   ',I12,  '  ',2A4)
    ...
    5 CONTINUE
      ...
      L2=L1+1
      IF(INDEX.EQ. 1) WRITE(JUSCRN,101) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ. 2) WRITE(JUSCRN,102) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ. 3) WRITE(JUSCRN,103) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ. 4) WRITE(JUSCRN,104) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ. 5) WRITE(JUSCRN,105) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ. 6) WRITE(JUSCRN,106) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ. 7) WRITE(JUSCRN,107) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ. 8) WRITE(JUSCRN,108) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ. 9) WRITE(JUSCRN,109) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.10) WRITE(JUSCRN,110) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.11) WRITE(JUSCRN,111) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.12) WRITE(JUSCRN,112) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.13) WRITE(JUSCRN,113) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.14) WRITE(JUSCRN,114) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.15) WRITE(JUSCRN,115) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.16) WRITE(JUSCRN,116) ACBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.17) WRITE(JUSCRN,117) ICBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.18) WRITE(JUSCRN,118) ICBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.19) WRITE(JUSCRN,119) ICBIN(INDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.20) WRITE(JUSCRN,120) ACBIN(JNDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.21) WRITE(JUSCRN,121) ACBIN(JNDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.22) WRITE(JUSCRN,122) ACBIN(JNDEX),(AFREE(L),L=L1,L2)
      IF(INDEX.EQ.23) WRITE(JUSCRN,123) ICBIN(JNDEX),(AFREE(L),L=L1,L2)
