C   19/02/84 409061158  MEMBER NAME  BANKPR2  (S)           FORTRAN
C
C-----------------------------------------------------------------------
      SUBROUTINE BANKPR
C-----------------------------------------------------------------------
...
C****************************** WRITE BANK HEADER
      ...
      NAME=IDATA(LIM1-1)
      CALL CORE(HDSPL,76)
      WRITE(10,9001) (IDATA(LHO),LHO=LIM1,LIMX),(HDATA(LIMHX+J),J=1,2)
...
9025  HWORK(I+100) = HDATA(LLO)
     ...
     $ WRITE(JUSCRN,9011) (HWORK(LLO+100),LLO=1,ILIM)
      IF(NAMEB.EQ.NAMES(3).OR.NAMEB.EQ.NAMES(4).OR.NAMEB.EQ.NAMES(16))
     $ WRITE(JUSCRN,9111) (HWORK(LLO+100),LLO=1,ILIM)
 9011 FORMAT(' ',20I6)
...
3181  FORMAT(' NR   ADC(L)  ADC(R)   TDC(L)  TDC(R)   TDC1(L)  TDC1(R)
     $ ADCF(L)  ADCF(R)   TDCF(L)  TDCF(R)   TDC(SPARE)')
      ...
      CALL CORE(HWORK,106)
      WRITE(JUSCRN,3185) I,(HADC(J,I),J=1,2),(HTDC(J,I),J=1,2),
...
3179  CALL CORE(HWORK,55)
      WRITE(JUSCRN,3187) I,(HADC(J,I),J=1,2),(HTDC(J,I),J=1,2),
     $ (HTDC1(J,I),J=1,2)
...
2782  LO = IDATA(LIM2+1)
      ...
      IPO = LIM2 + LO
      CALL CORE(HWORK,106)
      WRITE(JUSCRN,278) (IDATA(LIM2+II),II=1,LO)
278   FORMAT('  ',6I8,2F8.4,5I8)
      ...
      YS = YS - DEL
      CALL CORE(HWORK,124)
      WRITE(JUSCRN,178) (ADATA(LIM2+II),II=7,LO1)
...
276   IPP = IPO + (ICNT-1)*LTR
      ...
      IF(LTR.EQ.10)
     1  WRITE(JUSCRN,274) (ADATA(IPP+I),I=1,5),(IDATA(IPP+I),I=6,7),
     2 (ADATA(IPP+I),I=8,10)
274   FORMAT(' ',4F10.4,2X,F10.6,2X,2I4,2X,3F10.3)
      IF(LTR.EQ.12)
     1  WRITE(JUSCRN,284) (ADATA(IPP+I),I=1,5),(IDATA(IPP+I),I=6,7),
...
4177  LIM2 = LIM2 - 1
      LIMLIM = 2*LIM2
      CALL CORE(HWORK,13)
      WRITE(JUSCRN,4178) HDATA(LIMLIM+1),HDATA(LIMLIM+2)
4178  FORMAT(' ',I4,I8)
      CALL SYSSYM(XS,YS,SIZE,HWORK,13,0.)
      YS = YS - DEL
      CALL CORE(HWORK,108)
      WRITE(JUSCRN,4179) (ADATA(LIM2+1+I),I=1,7),IDATA(LIM2+9),
     1 ADATA(LIM2+10)
4179  FORMAT(' ',3E12.4,2X,3E12.4,2X,E12.4,I4,3X,E12.4)
      CALL SYSSYM(XS,YS,SIZE,HWORK,108,0.)
      YS = YS - DEL
      CALL CORE(HWORK,51)
      WRITE(JUSCRN,4175) (HDATA(LIMLIM+20+I),I=1,10)
4175  FORMAT(' ',10I5)
...
4171  IVX1 = 20
      ...
      YS = YS - DEL
      CALL CORE(HWORK,101)
      WRITE(JUSCRN,4174) (HDATA(LIMLIM+IVX+I),I=1,IVX1)
4174  FORMAT(' ',20I5)
      LIMLO = IVX1*5 + 1
...
877   LIM2 = LIM2 - 1
      ...
      IPO = LIM2 + LO
      CALL CORE(HWORK,72)
      WRITE(JUSCRN,878) (IDATA(LIM2+II),II=1,LO)
...
876   IPP = IPO + (ICNT-1)*LTR
      CALL CORE(HWORK,123)
      WRITE(JUSCRN,679) IDATA(IPP+1),(HDATA(IPP*2+I),I=3,4),
...
679   FORMAT(' ',I2,1X,2(Z2,2X),I5,I3,2X,2F8.3,F10.3,3F7.3,2X,I3,2X,
     1 2F8.3,F10.3,3F7.3)
      ...
      YS = YS - DEL
      CALL CORE(HWORK,124)
      WRITE(JUSCRN,873) IDATA(IPP+18),(ADATA(IPP+I),I=19,23),
...
873   FORMAT(' ',I2,1X,F10.6,2F8.3,F10.6,F8.3,I3,1X,4F10.6,I2,1X,F10.2,
     1 2F8.2,I3)
      ...
      YS = YS - DEL
      CALL CORE(HWORK,122)
      WRITE(JUSCRN,872) (IDATA(IPP+I),I=34,48),HDATA(1+2*(IPP+1)),
     $ HDATA(2+2*(IPP+1))
...
C--------------- SPECIAL FORMAT FOR GVTX BANKS
      ...
      IPO = LIM2+(INV-1)*10
      CALL CORE(HWORK,72)
      WRITE(JUSCRN,1279) IDATA(IPO+1),(ADATA(IPO+1+JJ),JJ=1,6),IDATA(IPO
...
1280  FORMAT(' ',I3)
      ...
      IPO = IPO+15
      CALL CORE(HWORK,64)
      WRITE(JUSCRN,1282) IDATA(IPO+1),(ADATA(IPO+1+JJ),JJ=1,8)
1282  FORMAT(' ',I3,F8.2,2F7.3,3F8.2,2F7.3)
      CALL SYSSYM(XS,YS,SIZE,HWORK,64,0.)
      YS = YS - DEL
      CALL CORE(HWORK,42)
      WRITE(JUSCRN,1285) (ADATA(IPO+1+JJ),JJ=9,11),
...
1380  FORMAT(' ',I3)
      ...
      IPO = LIM2+1+(ITR-1)*10
      CALL CORE(HWORK,82)
      WRITE(JUSCRN,1379) IDATA(IPO+1),(ADATA(IPO+1+JJ),JJ=1,6),IDATA(IPO
     $ +8),ADATA(IPO+9)
...
C--------------- SPECIAL FORMAT FOR TOFR BANKS
      ...
      LIM2 = LIM2 - 1
      CALL CORE(HWORK,17)
      WRITE(JUSCRN,1980) (IDATA(LIM2+I),I=1,4)
1980  FORMAT(' ',4I4)
      ...
      IPO = LIM2+4+(ITR-1)*14
      CALL CORE(HWORK,118)
      WRITE(JUSCRN,1979) (IDATA(IPO+I),I=1,3),(ADATA(IPO+I),I=4,14)
1979  FORMAT(' ',3I3,F8.2,F8.0,4F8.2,4F12.3,F12.0)
...
C--------------- SPECIAL FORMAT FOR LGCL BANKS
      LIM2 = LIM2 - 1
      CALL CORE(HWORK,29)
      WRITE(JUSCRN,1680) (IDATA(LIM2+LL),LL=1,4)
1680  FORMAT(' ',4I7)
      CALL SYSSYM(XS,YS,SIZE,HWORK,29,0.)
      LIM2 = LIM2 + 4
      YS = YS - DEL
      CALL CORE(HWORK,118)
      WRITE(JUSCRN,1681) (IDATA(LIM2+LL),LL=1,6),(ADATA(LIM2+LL),LL=7,1000052800
...
1681  FORMAT(' ',I3,I9,4I4,4F8.3,I4,4F8.3,2I3,I6,3I3)
      ...
      YS = YS - DEL
      CALL CORE(HWORK,101)
      WRITE(JUSCRN,1682) ((HDATA(LIM22+L),HDATA(LIM22+L+1)),L=1,NCLS2,2)
1682  FORMAT(' ',20I5)
      ...
      CALL CORE(HWORK,119)
C     IF(ILABEL.EQ.2)
      WRITE(JUSCRN,1679) IDATA(IPO+1),(ADATA(IPO+1+JJ),JJ=1,6),IDATA(IPO
     $ +8),(ADATA(IPO+JJ),JJ=9,NWPCL)
1679  FORMAT(' ',I3,2F8.3,2F9.2,2F8.3,I4,4F8.3,F10.3,2F6.3,F7.3)
C     IF(ILABEL.EQ.1)
C    $WRITE(JUSCRN,1675) IDATA(IPO+1),(ADATA(IPO+1+JJ),JJ=1,6),IDATA(IPO
...
2242  YS = YS - DEL
      CALL CORE(HWORK,77)
      WRITE(JUSCRN,2245) (HDATA(LH2+NTRI+K),K=1,4)
...
2246  AA = HDATA(LH2+NCOU+2)*.1
      YS = YS - DEL
      CALL CORE(HWORK,53)
      WRITE(JUSCRN,2249) HDATA(LH2+NCOU+1),AA,HDATA(LH2+NCOU+3),
     $ HDATA(LH2+NCOU+4)
...
2250  AA1 = HDATA(LH2+NL+5)*.001
      ...
      YS = YS - DEL
      CALL CORE(HWORK,124)
      WRITE(JUSCRN,2253) (HDATA(LH2+NL+K),K=1,4),AA1,AA2,AA3,AA4,
...
2254  CONTINUE
      YS = YS - DEL
      CALL CORE(HWORK,46)
      WRITE(JUSCRN,2257) (HDATA(LH2+ND+K),K=1,3)
2257  FORMAT(' ID ZVTX FLAG ',I3,'  ZVTX IN MM ',I6,' INRGZV ',I2)
      ...
      NTRT = HDATA(LH2+ND+5)
      CALL CORE(HWORK,49)
      IF(NTR.LT.0) WRITE(JUSCRN,2258)
2258  FORMAT(' PATTERN RECOGNITION NOT PERFORMED              ')
      IF(NTR.EQ.0) WRITE(JUSCRN,2259)
...
2260  FORMAT(' PATREC PERFORMED,',I3,' TRACKS FOUND',I3,' TRACK BANKS')
      ...
      YS = YS - DEL
      CALL CORE(HWORK,102)
      WRITE(JUSCRN,2261) NTRT,LORT,LTRT,MWR1,MWR2,MWR3,IEFA
...
2271  CONTINUE
      YS = YS - DEL
      CALL CORE(HWORK,50)
      WRITE(JUSCRN,2274) (HDATA(LH2+NTG+K),K=1,2)
...
C
      DO 2553 IHIT = 1,HZLENG,2
        ...
        IZWRD1 = IZWORD
        KANAL1 = LAND( SHFTR(IZWORD,11),15)
        HITCN1 = LAND( SHFTR(IZWORD,8),3)
        IBT151 = 0
...
C
        ...
        IZWRD2 = IZWORD
        KANAL2 = LAND( SHFTR(IZWORD,11),15)
        HITCN2 = LAND( SHFTR(IZWORD,8),3)
        IBT152 = 0
...
2554    IILIM = 108
        CALL CORE(HWORK,IILIM)
        WRITE(JUSCRN,2552) IZWRD1,IBT151,KANAL1,IFIFF1,HITCN1,IUNDF1,
     $  IOVRF1,IZWRT1,
...
C--------------- SPECIAL FORMAT FOR N50S BANKS
      ...
      YS = YS - DEL
      CALL CORE(HWORK,86)
      WRITE(JUSCRN,3236) HDATA(LH2+3),HDATA(LH2+11),HDATA(LH2+12)
...
3227  YS = YS - DEL
      CALL CORE(HWORK,77)
      WRITE(JUSCRN,3231) (HDATA(LH2+NTRI+K),K=1,4)
...
3237  AA = HDATA(LH2+NCOU+2)*.1
      YS = YS - DEL
      CALL CORE(HWORK,53)
      WRITE(JUSCRN,3241) HDATA(LH2+NCOU+1),AA,HDATA(LH2+NCOU+3),
     $ HDATA(LH2+NCOU+4)
...
3242  AA1 = HDATA(LH2+NL+5)*.001
      ...
      YS = YS - DEL
      CALL CORE(HWORK,124)
      WRITE(JUSCRN,3245) (HDATA(LH2+NL+K),K=1,4),AA1,AA2,AA3,AA4,
     $ (HDATA(LH2+NL+KK),KK=9,10)
...
3246  CONTINUE
      YS = YS - DEL
      CALL CORE(HWORK,46)
      WRITE(JUSCRN,3249) (HDATA(LH2+ND+K),K=1,3)
...
3252  FORMAT(' PATTERN RECOGNITION PERFORMED,',I3,' TRACKS FOUND')
      ...
      YS = YS - DEL
      CALL CORE(HWORK,48)
      WRITE(JUSCRN,3212) NTRT,LORT,LTRT
...
3253  CONTINUE
      ...
      NMU = 2*NMU + 1
      CALL CORE(HWORK,64)
      WRITE(JUSCRN,3256) HDATA(LH2+NM),HDATA(LH2+NM+1),
     $ (HDATA(LH2+NM+K),K=2,NMU,2)
3256  FORMAT(' NR MUON TRACKS ',I2,'   IN BARREL ',I3,' POSITION ',5I4)
      CALL SYSSYM(XS,YS,SIZE,HWORK,NCORE,0.)
      YS = YS - DEL
      CALL CORE(HWORK,64)
      WRITE(JUSCRN,3257) (HDATA(LH2+NM+K+1),K = 2,NMU,2)
...
3283  CONTINUE
      YS = YS - DEL
      CALL CORE(HWORK,50)
      WRITE(JUSCRN,3286) (HDATA(LH2+NTG+K),K=1,2)
...
3287  HDUM(I) = HSX(I,IBT)
      YS = YS - 2*DEL
      CALL CORE(HWORK,43)
      WRITE(JUSCRN,3261) (HDUM(I),I=1,13)
...
3289  HDUM(I) = HSX(I,5)
      YS = YS - 2*DEL
      CALL CORE(HWORK,61)
      WRITE(JUSCRN,3262) (HDUM(I),I=1,13),MUH
...
8287  HDUM(I) = HSY(I,IBT)
      YS = YS - DEL
      CALL CORE(HWORK,41)
      WRITE(JUSCRN,8261) (HDUM(I),I=1,13)
...
C--------------- SPECIAL FORMAT FOR ZVTX BANKS
      LIM2 = LIM2 - 1
      CALL CORE(HWORK,50)
      WRITE(JUSCRN,1579) (ADATA(LIM2+I),I=1,3),(IDATA(LIM2+I),I=4,6)
...
2077  LIM2 = LIM2 - 1
      LIMH2 = 2*LIM2
      CALL CORE(HWORK,62)
      WRITE(JUSCRN,2079) IDATA(LIM2+1),IDATA(LIM2+2),(HDATA(LIMH2+I),I=
     $5,14)
2079  FORMAT('  ',I8,2X,I8,2X,10I4)
      CALL SYSSYM(XS,YS,SIZE,HWORK,62,0.)
      YS = YS - DEL
      CALL CORE(HWORK,114)
      WRITE(JUSCRN,2080) (HDATA(LIMH2+I),I=15,34)
2080  FORMAT('  ',16I5,4I8)
      CALL SYSSYM(XS,YS,SIZE,HWORK,114,0.)
      YS = YS - DEL
      CALL CORE(HWORK,122)
      WRITE(JUSCRN,2081) (ADATA(LIM2+I),I=18,27)
2081  FORMAT('  ',10E12.4)
      CALL SYSSYM(XS,YS,SIZE,HWORK,122,0.)
      YS = YS - DEL
      CALL CORE(HWORK,54)
      WRITE(JUSCRN,2082)(HDATA(LIMH2+I),I=55,56),(ADATA(LIM2+I),I=29,31)
2082  FORMAT('  ',2I5,3E14.6)
      CALL SYSSYM(XS,YS,SIZE,HWORK,54,0.)
      YS = YS - DEL
      CALL CORE(HWORK,110)
      WRITE(JUSCRN,2083) (ADATA(LIM2+I),I=32,40)
2083  FORMAT('  ',9E12.4)
      CALL SYSSYM(XS,YS,SIZE,HWORK,110,0.)
      YS = YS - DEL
      CALL CORE(HWORK,120)
      WRITE(JUSCRN,2084)(HDATA(LIMH2+I),I=81,82),(ADATA(LIM2+I),I=42,50)
2084  FORMAT('  ',2I5,9E12.4)
      CALL SYSSYM(XS,YS,SIZE,HWORK,120,0.)
      YS = YS - DEL
      CALL CORE(HWORK,72)
      WRITE(JUSCRN,2085) (ADATA(LIM2+I),I=51,55)
2085  FORMAT('  ',5E14.6)
      CALL SYSSYM(XS,YS,SIZE,HWORK,72,0.)
      YS = YS - DEL
      CALL CORE(HWORK,52)
      WRITE(JUSCRN,2086) (HDATA(LIMH2+I),I=111,120)
2086  FORMAT('  ',10I5)
...
2177  LIM2 = LIM2 - 1
      LIMH2 = 2*LIM2
      CALL CORE(HWORK,110)
      WRITE(JUSCRN,2179) (HDATA(LIMH2+I),I=1,18)
2179  FORMAT('  ',18I6)
      CALL SYSSYM(XS,YS,SIZE,HWORK,110,0.)
      YS = YS - DEL
      CALL CORE(HWORK,122)
      WRITE(JUSCRN,2180) (ADATA(LIM2+I),I=10,19)
2180  FORMAT('  ',10E12.4)
      CALL SYSSYM(XS,YS,SIZE,HWORK,122,0.)
      YS = YS - DEL
      CALL CORE(HWORK,78)
      WRITE(JUSCRN,2181) IDATA(LIM2+20),ADATA(LIM2+21),IDATA(LIM2+22),
     $ (ADATA(LIM2+I),I=23,25),IDATA(LIM2+26)
2181  FORMAT('  ',I6,E14.6,I6,3E14.6,I8)
      CALL SYSSYM(XS,YS,SIZE,HWORK,78,0.)
      YS = YS - DEL
      CALL CORE(HWORK,112)
      WRITE(JUSCRN,2182)(ADATA(LIM2+I),I=27,33),(HDATA(LIMH2+I),I=67,68)
2182  FORMAT('  ',7E14.6,2I6)
      CALL SYSSYM(XS,YS,SIZE,HWORK,112,0.)
      YS = YS - DEL
      CALL CORE(HWORK,112)
      WRITE(JUSCRN,2183)(ADATA(LIM2+I),I=35,38),(HDATA(LIMH2+I),I=77,78)
     $,(ADATA(LIM2+I),I=40,42)
2183  FORMAT('  ',4E14.6,2I6,3E14.6)
      CALL SYSSYM(XS,YS,SIZE,HWORK,112,0.)
      YS = YS - DEL
      CALL CORE(HWORK,74)
      WRITE(JUSCRN,2184) (HDATA(LIMH2+I),I=85,96)
2184  FORMAT('  ',12I6)
      CALL SYSSYM(XS,YS,SIZE,HWORK,74,0.)
      YS = YS - DEL
      CALL CORE(HWORK,120)
      WRITE(JUSCRN,2185) (ADATA(LIM2+I),I=49,57)
2185  FORMAT('   ',9E13.5)
      CALL SYSSYM(XS,YS,SIZE,HWORK,120,0.)
      YS = YS - DEL
      CALL CORE(HWORK,86)
      WRITE(JUSCRN,2186) IDATA(LIM2+58),(ADATA(LIM2+I),I=59,64)
2186  FORMAT('   ',I5,6E13.5)
      CALL SYSSYM(XS,YS,SIZE,HWORK,86,0.)
      YS = YS - DEL
      CALL CORE(HWORK,100)
      WRITE(JUSCRN,2187) (ADATA(LIM2+I),I=65,71)
2187  FORMAT('  ',7E14.6)
      CALL SYSSYM(XS,YS,SIZE,HWORK,100,0.)
      YS = YS - DEL
      CALL CORE(HWORK,98)
      WRITE(JUSCRN,2188) IDATA(LIM2+72),(ADATA(LIM2+I),I=73,78)
