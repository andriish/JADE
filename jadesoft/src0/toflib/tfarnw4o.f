C   11/01/81 701061744  MEMBER NAME  TFARNW4  (S)           FORTRAN
...
C
 1500 CONTINUE
  ...
  420 FORMAT(' HSTAT',42I3)
      TDCM = HTDC(1,NCN)
      IF(NRUN.GT.24200) TDCM = TDCM-HTSPAR(3)+465.
      TDCP = HTDC(2,NCN)
      IF(NRUN.GT.24200) TDCP = TDCP-HTSPAR(3)+465.
C
