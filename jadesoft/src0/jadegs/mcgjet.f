C   24/10/81 110261419  MEMBER NAME  MCGJET   (JADEGS)      FORTRAN
...
C
C --------------------------------------------------------------
      COMMON /MARKET/ PAR(3,4)
      COMMON /SENSE/ PP(4,100),INUM
      COMMON /WT/ IWT
      COMMON /CWT/ JWT
...
C
C
      COMMON /CRUST/ AXIS(3),ATRST
C
C
      COMMON /COLD/ IJ(4),PTH(3,100,4),IPJ(100,4)
C
...
C
      COMMON /CJRUST/ THJ,THRUJ(3)
C
      DIMENSION TEMP(3,4),TPTH(3,100,4),ITPJ(100,4),ITJ(4)
      DIMENSION IPP(4,100),ANG(4),COMP(4),TREM(4)
C
