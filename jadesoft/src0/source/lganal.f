C   11/07/79 601241046  MEMBER NAME  LGANAL   (SOURCE)      FORTRAN
      SUBROUTINE LGANAL
C
...
C---- *******  MODIFIED FOR BOS *******
C
C            16/01/86 : COPIED FROM JADELG.SOURCE(LGANAL)
C                                                         M. KUHLEN
C  LAST MOD. 16/01/86 : POSSIBILITY TO ERASE ONLY THE UNPHYSICAL
...
C                                   MESSAGE
 ...
 990  FORMAT(1X,'LGANAL:    CORRECTED VERSION FROM 24.1.1986 CALLED')
C
