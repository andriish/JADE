C   13/08/79 609032024  MEMBER NAME  LGCDIR   (SOURCE)      FORTRAN
...
C     LAST MOD. 03-09-86  J.OLSSON  CORRECT BUG IN MC BANK DESCRIPTOR
C
...
C
      WRITE(6,6232)
6232  FORMAT('  # # # #  LGCDIR: CORRECTED VERSION FROM 3.9.86   # #')
C
31    CONTINUE
C
C---- CHECK POINTERS
...
C2121    ISMR=SHFTR(MCWD,4)
2121    ISMR=LAND(IHELP,16)
