C   14/12/81 112141617  MEMBER NAME  POSEND   (SOURCE)      FORTRAN
C   08/12/81 112091346  MEMBER NAME  POSENDN  (SOURCE)      FORTRAN
...
C-- !!!!!!!!
C    BUG WAS FOUND  ON 8/12/1981   H.TAKEDA
C    IF THE INPUT CLUSTER ENERGY IN THE END CAP IS LESS THAN 600 MEV,
C    THE CORRECTED ENERGY IS NOT CORRECT.
C    THE CORRECTED ENERGY CONVERGES TO THE VALUE
C         SQRT(600(MEV) *EIN) , DUE TO THE BUG.
C    THIS BUG WAS CREATED DURING THE MODIFICATION BY WATANABE FROM
C    THE "CORRECT" ORIGINAL ONE.
C-- !!!!!!!!
...
C-- RECOVERY TO THE CORRECT ONE
      IF(I.EQ.1) HCOR(J,I)=1000
40    CONTINUE
C     WRITE(6,900) HCOR
C
50    FACT=1.
