C   07/04/82 204071334  MEMBER NAME  LGNBLS   (SOURCE)      FORTRAN
      SUBROUTINE LGNBLS( HPOS,NNBRO,LST)
C
C     S.YAMADA   26-12-77
C     LAST MODIFICATION   04-11-78  14:45
C       !! RECOPIED FROM F22YAM.LG.S(LGNBLS) SINCE THE MEMBER WAS
C          DESTROYED.     04-04-82  13:30
C          (THE COPIED MEMBER IS IDENTICAL TO THE OLD ONE.)
C
