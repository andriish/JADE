C   01/10/83 311220222  MEMBER NAME  OMUFFLY  (JADEMUS)     FORTRAN
C
C LAST CHANGE 02.30 22/11/83 HUGH MCCANN  - PROTECT MHREG AND ARRAYS.
...
C
      LOGICAL FOUND1,FOUND2,FOUNDL,NONE,BADT,BADL,BADH1
C
...
C   IS NO NEED TO DO THE WEDGE TESTS.
              IF(TEDGE1.LT.CT  .AND.  TEDGE2.GT.CT)GO TO 2205
                ...
                IF(WEDGE1.LT.TEDGE1  .AND.  WEDGE2.GT.TEDGE1)GO TO 2205
                 IF(WEDGE1.LT.TEDGE2  .AND.  WEDGE2.GT.TEDGE2)GO TO 220500054500
                   GO TO 2210
 2205           FOUNDL=.TRUE.
                FOUND1=.TRUE.
                FOUND2=.FALSE.
