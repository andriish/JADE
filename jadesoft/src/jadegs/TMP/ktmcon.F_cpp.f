C   31/01/79 609031108  MEMBER NAME  KTMCON   (JADEGS)      FORTRAN
...
C---
      ...
      NRUN = HDATA(2*IPHEAD + 10)
      NEVE = HDATA(2*IPHEAD + 11)
      WRITE(6,100) NRUN,NEVE
  100 FORMAT('0KTMCON CALLED WITH INVALID INPUT.  RUN EVENT = ',2I8)
