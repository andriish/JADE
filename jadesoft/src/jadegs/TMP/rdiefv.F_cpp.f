C   01/11/84 712221259  MEMBER NAME  RDIEFV   (JADEGS)      FORTRAN
C
C-----------------------------------------------------------------------
...
C        MOD  J. HAGEMANN 02/11/84 :  IMPROVED CODE
C   LAST MOD  J. HAGEMANN 13/11/86 :  UPDATED CODE
C
...
C
C   ERASE HITS ON WIRES 1 * 85 DUE TO COOLING PIPES
C
C-----------------------------------------------------------------------
C
...
C
                ...
                IF( (IAL + IAR) .GT. 0 ) GO TO 300
                   Z = 0.
                   GO TO 400
  300           Z = 0.5*ZALV*FLOAT(IAL - IAR)/FLOAT(IAR + IAL)
