C   19/02/84 402192241  MEMBER NAME  EVBKPR   (JADEGS)      FORTRAN
C
C----------------------------------------------------------------------
...
C
C   LAST MOD: C. BOWDERY  16/02/84 :  CREATE THIS AS SEPARATE S/R
C
C----------------------------------------------------------------------
C
...
C
  4     WRITE(6,3) LNAM, IDATA( IPLNAM - 2), IDATA(IPLNAM)
