C   12/08/87 805101915  MEMBER NAME  CHIEN52  (S)           FORTRAN77
...
C                    FILL MEICL AND NEICL INTO NBLIST AND ENLIST
      ...
      WRITE( 6,9301 ) IM, NUMBLO, NBLIST(NUMBLO), ENLIST( NUMBLO )
 9301 FORMAT(3X,' CHIEN5 : IM, NUMBLO, NBLIST, ENLIST ',3I7,E12.4 )
  990 CONTINUE
C
...
C
        ...
        WRITE(6,9302) VERT, CHI2
 9302   FORMAT(3X,' CHIEN5 : SHWCPR1, VERT, CHI2 ' , 2E12.4 )
C
      XVA(KF)=CHI2
...
C                            OUT LEFT
      ...
      PIMP2=ZCO(1)
        CALL SHWCPR (VERT,CHI2)
        WRITE(6,9303) VERT, CHI2
 9303  FORMAT(3X,' CHIEN5 : SHWCPR2, VERT, CHI2 ' , 2E12.4 )
      XVA(1)=CHI2
      GO TO 530
C                            OUT RIGHT
  521 CONTINUE
      ...
      PIMP2=ZCO(5)
        CALL SHWCPR (VERT,CHI2)
        WRITE(6,9304) VERT, CHI2
 9304    FORMAT(3X,' CHIEN5 : SHWCPR3, VERT, CHI2 ' , 2E12.4 )
      XVA(5)=CHI2
  530 CONTINUE
...
C                            FINAL CALL TO 'SHWCPR'
        ...
        WRITE(6,9305) VERT, CHI2
 9305   FORMAT(3X,' CHIEN5 : SHWCPR4, VERT, CHI2 ' , 2E12.4 )
C
      CHI2N = CHI22 / NUMBLO
      PCHI2=PROB(CHI22,NUMBLO)
      WRITE(6,9306) PCHI2, CHI22, NUMBLO, CHI2N
 9306 FORMAT( 3X,'CHIEN5 : PROB( CHI22, NUMBLO ) , NORMAL. CHI2 ',
     *        3E12.4,I10)
C
      RETURN
 1170 WRITE(6,1175)
 ...
 1185 FORMAT(1X,' ARGUMENT ARSIN.GT.1 <<<<<',F10.5,/,1X,4F20.10)
      ...
      RETURN
      END
C   07/01/84 401071436  MEMBER NAME  NREG     (DRIFTS)      FORTRAN
