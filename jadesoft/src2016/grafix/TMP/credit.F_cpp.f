...
2200  WRITE(6,503) HNTR
      ...
      WRITE(6,505)
***PMF      WRITE(6,506) ((I,IPCL(I),NRHT(I),NWR1(I),DS1(I),SL1(I),NWR2(I),
***PMF     $ DS2(I),SL2(I),LBL(I),NTREL(I),ICRO(I)),I=1,HNTR)
...
C---     WRITE PATREC CAPTION
      ...
      CALL MOVEA(XXX,YYY)
      CALL CORE(HWORK,42)
      WRITE(cHWORK,6799) NTR,HNTR ! PMF 17/11/99: UNIT=10 changed to cHWORK
...
972   KITR = KITR + 1
      IPPATR=IDATA(IPATR)
      IF(KITR.EQ.1) IDATA(IPPATR+LHEAD) = IBITON(IDATA(IPPATR+LHEAD),0)
...
2879  FORMAT(' IPPATR LO ITR IDLO1 IDLO48 ',4I6,2X,Z8)
      ...
      IDATA(LO+48) = IBITON(IDATA(LO+48),0)
