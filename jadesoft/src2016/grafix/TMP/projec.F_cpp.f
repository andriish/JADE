...
*** PMF 26/11/99: PLTFLG is needed for special settings
*                 of graphics attributes using subroutine SETCOL
      INTEGER PLTFLG
...
C
      pltflg=1 ! PMF 26/11/99: activate special graphics attributes
      NACMD = ACMD
      FL18  = .TRUE.
C
...
C
      call setcol('JADE') ! PMF 24/11/99: set colour
...
C
  50  KPROJ = 2
      ...
      pltflg=0   ! PMF 26/11/99: deactivate special graphics attributes
C
C
      FL18 = .FALSE.
