C   14/12/81 705221139  MEMBER NAME  LGECORZ  (S)           FORTRAN
...
C      LAST MODIFICATION   22/05/87 J.OLSSON
C                          ENLOSG INSTEAD OF ENGLOS  (PITZL)
...
2361  FORMAT(' FOR ENLOSG  EINC D ETHRE ',3E12.4)
C
      CALL ENLOSG(EINC,D,DELTAE,*80)
      EEXP=EINC-DELTAE
C
      IF(IPRO.NE.0) WRITE(6,2362) EEXP,DELTAE
2362  FORMAT(' AFT ENLOSG  EEXP DELTAE ',3E12.4)
C
