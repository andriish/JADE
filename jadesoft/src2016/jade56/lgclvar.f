C   27/04/81 705171415  MEMBER NAME  LGCLVAR  (S)           FORTRAN
...
C--       DELETE LGCL BANK AND SCALE ALGN WITH CONSTANT FACTOR
C--       RECREATE LGCL, UPDATE RESO
C                                                 LAST CHANGE  2.05.87
...
C
      ...
      IAD1 = IAD / 32
      IAD1 = IAD - IAD1*32
      IF(IAD1.GE.13.AND.IAD1.LE.18) ISF6 = 1
5009  CONTINUE
      SCALE = SCLGC5
