C   15/11/81 708291857  MEMBER NAME  INTSHW9  (S)           FORTRAN
...
C      CHANGE  16.1.1986
C  LAST CHANGE  29.8.1987    (ENELEL,ENELPO)
C                                   J.OLSSON
      COMMON / COLSON/ IPRO
      COMMON /TOTPAT/ PATH
...
C     DIMENSION ELTBL(200)
      DIMENSION ELOSEL(200),ELOSPO(200)
      DIMENSION ALTBL(200),ALTBL2(200)
      DIMENSION ECUTLS(3)
C     DIMENSION BUFF(40,10),BELTBL(200,10),BTETB0(21,10)
      DIMENSION BUFF(40,10),BELTEL(200,10),BELTPO(200,10),BTETB0(21,10)
      DIMENSION BDTETB(20,10),BATBT0(21,10)
C     NAMELIST /DMP/ ELTBL,TETBL0,ATETB0
      NAMELIST /DMP/ ELOSEL,ELOSPO,TETBL0,ATETB0
      DATA KPMAX/40/
...
C       ELTBL(I)=ENELS(ENE)
   ...
   55   ENE=ENE+1.
C
C     WRITE(6,8221) (ELTBL(I),I=1,200)
C221  FORMAT(' ',20(' ELTBL ',10(F10.4,1X),/))
      WRITE(6,8221) (ELOSEL(I),I=1,200)
8221  FORMAT(' ',20(' ELOSEL ',10(F10.4,1X),/))
      WRITE(6,8222) (ELOSPO(I),I=1,200)
8222  FORMAT(' ',20(' ELOSPO ',10(F10.4,1X),/))
C
      ENE=ECUTPH
        DO 60 I=1,NRCOM1
...
C     CALL MVCL( BELTBL(1,IMATTR), 0, ELTBL , 0, 200*4)
      CALL MVCL( BELTEL(1,IMATTR), 0, ELOSEL , 0, 200*4)
      CALL MVCL( BELTPO(1,IMATTR), 0, ELOSPO , 0, 200*4)
...
C     CALL MVCL( ELTBL , 0, BELTBL(1,IMATTR), 0, 200*4)
      CALL MVCL( ELOSEL, 0, BELTEL(1,IMATTR), 0, 200*4)
      CALL MVCL( ELOSPO, 0, BELTPO(1,IMATTR), 0, 200*4)
...
2201  CONTINUE
 ...
 2211   POS(I)=POS(I)+DIR(I)*TS
      ...
      I=IFIX(ENE0-ECUT)+1
      IF(I.GT.NRR2)I=NRR2
C     ENE0=ENE0-T*ELTBL(I)
      IF(CHG0.LT.0.) ENE0=ENE0-T*ELOSEL(I)
      IF(CHG0.GT.0.) ENE0=ENE0-T*ELOSPO(I)
 2202 FLEN0=FLEN0+T
