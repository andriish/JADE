C   09/11/78 704042131  MEMBER NAME  FNPECERO (S)           FORTRAN
      SUBROUTINE NPECER(JBE,Z,COST,PENUM,A)
C     S.YAMADA    12-12-77
C---- CALCULATE NUMBER OF PHOTOELECTRONS BY CERECKOV LIGHT.
C
C   THIS IS MEMBER NPECERO ON F22YAM.WORKS, COPIED ON 29.1.1986
C      THIS IS THE NPECER WHICH IS DESCRIBED IN JADE NOTE 20
C
C
C INPUT
