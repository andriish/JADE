C   14/12/81 704301124  MEMBER NAME  LGECORX  (S)           FORTRAN
...
C                            Y                   END CAP
C    IDATA(8)   NUMBER OF CORRESPONDING INNElgecorxR TRACKS
...
C
      ...
      EEXP= EEXP*PFAC
C
      IF(IPRO.NE.0) WRITE(6,2365) EEXP,PFAC,ADATA(11),ADATA(4)
2365  FORMAT(' AFT BRLGN  EEXP PFAC ADATA 11 4 ',4E12.4)
C
C
      EDIF= ENERGY -EEXP
C
