C   23/06/78 705112108  MEMBER NAME  NPECER   (S)           FORTRAN
      SUBROUTINE NPECER(JBE,Z,COST,PENUM)
C
C####
C#   THIS VERSION GIVES IDENTICAL RESULT TO THE LOAD MODULE ON
C#   F22YAM.LGLOAD, WHICH IS STANDARDLY USED IN THE OLD SF5 VERSION
C#   THE SOURCE CODE OF THE MODULE IS MISSING ON LGSOURCE.
C####
C     S.YAMADA    12-12-77
...
C
      ...
      DATA B/58.22,29.2, -1150.6, 4664.1, -6253.8,685.51,4351.7,-2296.5,
     1 0.4225,1.0556,-1.6712, 9.0240, 2.8498, -23.35,-0.9666, 15.58,
