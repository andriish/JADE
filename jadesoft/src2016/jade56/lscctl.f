C   09/11/81 712202132  MEMBER NAME  LSCCTL   (S)           FORTRAN
...
C
C   USE SUBR. TJOCKI RESULTS, TO ADD EXTRA ENERGY LOSS IN COIL MATERIAL,
C   DUE TO OTHER MATERIAL THAN ALUMINIUM
C
C --->  MADE STANDARD LSCCTL ON 20.12.1987, EVENING
C
