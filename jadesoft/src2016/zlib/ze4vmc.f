C   11/01/87 804281850  MEMBER NAME  ZE4VMC   (S)           FORTRAN77
***PMF09/12/99      SUBROUTINE ZE4VMC( ITRK, IRES, /IARG3/, /IARG4/, /IARG5/ )
      SUBROUTINE ZE4VMC( ITRK, IRES, IARG3, IARG4, IARG5 )
C-----------------------------------------------------------
C   VERSION OF 24/01/85    LAST MOD 28/04/88    MZ
...
C
     ...
     +                      )   )
              if(itypp.ge.100000) itypp=itypp-100000 ! PMF 09/12/99
...
C
            ...
            IF( ITYPE.EQ.2 .OR. ITYPE .EQ. 3) HR(2) = - HR(2)
            IORI = HR(2)
          ENDIF
        ELSE
          IM = 0
