C   29/04/80 011111125  MEMBER NAME  MCREDU   (CS11)        FORTRAN
      SUBROUTINE zMCREDU( EBEFIX, * ) !PMF 11/04/00 MCREDU->zMCREDU
C-----------------------------------------------------------
C  VERSION OF 29/04/80      LAST MOD 02/11/80     E.ELSEN
C  CUTS FOR MC REDUCTION.
