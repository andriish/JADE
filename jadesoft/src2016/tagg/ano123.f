C   06/11/79 912181719  MEMBER NAME  ANO123   (S)           FORTRAN
      SUBROUTINE ANO123(IRUN)
C---  ANOMALIES OF RUNS 2077 - 2082
C---  15.03 GEV      OCTOBER 1979
C
...
C              INSTEAD OF 50
C
      GOTO (2077,2078,2079,2080,2081,2082),IRUN
   13 RETURN
C
 2077 LCHANN(79) = .TRUE.
      LCHANN(107) = .TRUE.
