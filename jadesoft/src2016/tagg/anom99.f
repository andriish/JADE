C   23/10/79 001221321  MEMBER NAME  ANOM99   (S)           FORTRAN
      SUBROUTINE ANOM99(IRUN)
C---  ANOMALIES OF RUNS 1946 - 1952
C---  15.60 GEV      OCTOBER 1979
C
C     H.WRIEDT    27.07.79     02:20
C     LAST MODIFICATION     22.01.80     13:20
C
...
C              INSTEAD OF 50
C
      GOTO (1946,1947,1948,1949,1950,1951,1952),IRUN
   13 RETURN
C
 1946 LCHANN(79) = .TRUE.
      LCHANN(107) = .TRUE.
