C   12/04/85 709111605  MEMBER NAME  TAGPS2   (S)           FORTRAN
C
...
C
      ...
      IF(THETA.LE.THMIN(I).OR.THETA.GT.THMAX(I))GOTO 145
            RATIO = MSLOPE(I)*THETA + CSLOPE(I)
            GOTO 146
145   CONTINUE
146   CONTINUE
C
C NOW PHI DEPENDANCE ( SEEMS FAIRLY INDEPENDENT OF THETA )
C
C
