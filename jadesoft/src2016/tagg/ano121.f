C   06/11/79 912180152  MEMBER NAME  ANO121   (S)           FORTRAN
      SUBROUTINE ANO121(IRUN)
C---  ANOMALIES OF RUNS 2063 - 2068
C---  15.01 GEV      OCTOBER 1979
C
C     H.WRIEDT    27.07.79     02:20
C     LAST MODIFICATION     18.12.79     01:50
C
...
C              INSTEAD OF 50
C
      GOTO (2063,2064,2065,2066,2067,2068),IRUN
   13 RETURN
C
 2063 LCHANN(79) = .TRUE.
      LCHANN(107) = .TRUE.
