C   05/05/85 807251153  MEMBER NAME  ZCASS    (JADEGS)      FORTRAN77
************************************************************************
...
*                                                                      *
*  20/5/88     ADD RRTRK TO RECORD RADII OF INTERSECTIONS, EE          *
*  25/7/88     CORRECT RRTRK TYPO IN IER.NE.0 BRANCH       EE          *
*                                                                      *
************************************************************************
*
******COMMONBLOCKS
...
*                              NTR)   TRACKNO
******              RRTRK(*,   NTR)   RI1, RI2 FOR TRACK NTR
...
*                    WITHIN DEAD SPACES OF Z-CHAMBER.
         ...
         ELSE
            ...
            RRTRK(1,I) = SQRT( XI1**2+YI1**2)
            RRTRK(2,I) = SQRT( XI2**2+YI2**2)
         ENDIF
         NCELL = (ZI1+1200.)/150.
         NWIRE = 2*NCELL + 1
