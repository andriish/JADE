C   02/03/82 411121142  MEMBER NAME  TOFMAS   (S)           FORTRAN
...
C  CREATES BANK TOFR
C  USES SINGLE TRACK ALGORITHM AND OLD BANKFORMAT
C  CREATES BANK TOFR
C  LAST MODIFIED 25.6.82
...
C  AD HOC CORR FOR BEGIN 1981
  322 TAUM1 = TAUM1 - TPARM(25)
      ...
      IF(NRUN.GE.10000) TAUM1= TAUM1+3.07
      IF(NRUN.GE.10000) TAUP1= TAUP1+3.07
      IF(NRUN.GE.10000.AND.I.EQ.2) TAUM1 = TAUM1  -CC2M
  321 CONTINUE
C
      NFLG= -1
...
C
 ...
 360  CONTINUE
      ...
      TDCP = HTDC(2,I)
      NFLG = NFLG * MTPY
      CALL CMASS( I,PMEV1,TOF1,PATH1,BET1,DBET1,EMAS12,DMAS1,
     -            PRO1,PKA1,PPI1,PEL1)
      CALL TFSTOR(NTR1,NFLG,I,TOF1,PATH1,BET1,DBET1,EMAS12,DMAS1,
     -            PRO1,PKA1,PPI1,PEL1,ZTOF1)
C           CALL TFSTOR(NTR1,NFLG,I,TOF1,PATH1,TDCM,TDCP,ADCM,ADCP,
C    -            TAUM1,TAUP1,ITRC(NTR1),0.,ZTOF1)
      NOK= NOK+1
C
 1001 CONTINUE
 1000 CONTINUE
