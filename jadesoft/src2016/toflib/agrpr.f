C   18/06/82 311231024  MEMBER NAME  AGRPR    (S)           FORTRAN
      SUBROUTINE AGRPR(IPTOF,*)
C
C  SPECIAL VERSION FOR GRAPHICS WHERE PRINT STATEMENTS
C  TAKEN OUT
C
...
C
      ...
      COMMON/TFPED/ HSTAT(42),HON(42)
      COMMON/FWPED/ HFSTAT(16),HFON(16)
      COMMON/TFPED1/HON1(42),HHSPAR(16)
...
C
      ...
      CALL SETSL(HTDC,0,42*4,0)
      CALL SETSL(HTDC1,0,42*4,0)
      CALL SETSL(HADCF,0,16*4,0)
      CALL SETSL(HTDCF,0,16*4,0)
C
      NRUN = HEADR(18)
      JPTOF = IPTOF*2
      NLENG = IDATA(IPTOF)*2
...
C
  200 CONTINUE
   ...
   39 IERRAD = IERRAD + 1
      IEV  = HEADR(19)
C     IF(IERRAD.LE.20) PRINT 902,NRUN,IEV,IBUG,IERRAD,IADD,IAD,IBD
C 902 FORMAT(' MESS. FROM TOF PROG : NRUN,IEV,NEV ',3I8,
C    *    ' ERROR IN TOF ADDR',4I5)
C     CALL ATOFRW(IPTOF)
...
C
  ...
  460 CONTINUE
      ...
      IF(ITOFA+ITFAD-2.GT.ITOFE)  RETURN
      IAD = IADD - 99
C     PRINT 1401,IADD,IAD
1401  FORMAT(' FWTF  ',10I5)
