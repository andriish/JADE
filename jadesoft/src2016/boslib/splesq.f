C   07/06/96 606071911  MEMBER NAME  SPLESQ   (S4)          FORTG1
      SUBROUTINE SPLESQ(Y,X,W,N,A,NSP,IEQ,CHDF)
...
C
C     A( ) = AUXILIARY ARRAY OF LENGTH 5*NSP (AT LEAST).
C
C     IEQ = -2    X VALUES GIVEN
C                 ALL WEIGHTS EQUAL 1.0 (ARGUMENT W DUMMY)
C
C     IEQ = -1    EQUIDISTANT X VALUES  (ARGUMENT X DUMMY)
C                 ALL WEIGHTS EQUAL 1.0 (ARGUMENT X DUMMY)
C
C     IEQ = +1    EQUIDISTANT X VALUES  (ARGUMENT X DUMMY)
C                 WEIGHTS W GIVEN
C
