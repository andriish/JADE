C   29/09/80 009291225  MEMBER NAME  KALM1S   (JADESR)      FORTRAN
      SUBROUTINE KALADD
...
C---
C---     SPECIAL VERSION WHICH SUBTRACTS 201 SECONDS RATHER THAN 200
C---     FROM THE CAMAC CLOCK TIME.
C---                                   L.H. O'NEILL 29.09.80
...
C---
C---     SUBTRACT 201 SECONDS FROM EFFECTIVE TIME TO MAKE SURECHANGE
