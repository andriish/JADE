C   06/03/81 103061033  MEMBER NAME  KALADDFX (JADESR)      FORTRAN
      SUBROUTINE KALADD
      IMPLICIT INTEGER*2 (H)
C---
C---     VERSION FOR FIXING UP THE FEB. 29, 1981 CAMAC CLOCK SCREW UP.
C---                                   L.H. O'NEILL 06.03.81
C---
...
C         HAVING SHORT DATA.
      ...
      ITIME(5)=HCAT(9)
      ITIME(6)=HCAT(10)
         IF(ITIME(6).NE.1981) GO TO 1776
         IF(ITIME(5).NE.   2) GO TO 1776
         IF(ITIME(4).NE.  29) GO TO 1776
         WRITE(6,1775) ITIME
 1775    FORMAT(1X,' CORRECT ITIME',6I6)
         ITIME(5)=3
         ITIME(4)=1
 1776    CONTINUE
      LASTIM=0
