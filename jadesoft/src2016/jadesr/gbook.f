...
CAV      COMMON/CGBOOK/PLOT(116,1)
      COMMON/CGBOOK/PLOT(116,13)
      COMMON/CGB947/MAXLIN,MAXPLO
      INTEGER ITIT(1)
CAV      LOGICAL*1 TIT(40)
      CHARACTER*1 TIT(40)
CAV      LOGICAL*1 BLANK/1H /,LOGTIT(2)/1H ,1H /,TITEND
      CHARACTER*1 BLANK/1H /,LOGTIT(2)/1H ,1H /
      LOGICAL*1 TITEND
      INTEGER*4    IPLOT(116,1)
      INTEGER*2 COMTIT,DOLLAR/2H $/
...
CAV      CALL HF1(IDREF,X)
      CALL HF1(IDREF,X,1.0)
      RETURN
      END
      SUBROUTINE HF1(IDREF,X,WEIGHT)
CAV      COMMON/CGBOOK/PLOT(116,10)
      COMMON/CGBOOK/PLOT(116,13)
      INTEGER*4    IPLOT(116,1)
      COMMON/CGB947/MAXLIN,MAXPLO
