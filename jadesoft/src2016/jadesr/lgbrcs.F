C   25/02/82 203012233  MEMBER NAME  LGBRCS   (S)           FORTRAN
C
      SUBROUTINE LGBRCS(JCOSM)
C
C    S.YAMADA   15-02-82  14:00
C     LAST MODIFICATION   23-02-82  18:25
C                         TIGHTER CUT IS INTRODUCED.
C
...
C--     BIG AND LONG CLUSTER
        IF( EAB(2,1).GT.30000..AND. RB1.GT.0.08)  GO TO 1000
C--     MEDIUM SIZE;  CHECK DIRECTION IN PHI-Z PLANE
