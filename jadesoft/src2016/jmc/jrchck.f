C   02/10/78 606101308  MEMBER NAME  JRCHCK9  (S)           FORTRAN
C
C-----------------------------------------------------------------------
      SUBROUTINE JRCHCK( X, P, IRING, IPOS, IRETRN, *, CA, SA, DRMAX)
C-----------------------------------------------------------------------
C
C   AUTHOR:   E. ELSEN    02/01/79 :  CHECKS FRAME CONDITIONS FOR DRIFT
C                                     SPACE IN RING IRING IN JET CHAMBER
C
C        MOD  E. ELSEN    07/10/81 :
C   LAST MOD  J. HAGEMANN 21/09/84 :  NEW VERSION OF SUBROUTINE JRCHCK
C                                     IMPLEMENTED
C
...
C                 = 6 : NEXT ELEMENT, CHANGING PHI TOWARDS THE
C                       NEIGHBORINGSPACE IN SAME CELL
C                       ( ONLY VALID FOR RING THREE ).
C
