C   05/12/83 606101317  MEMBER NAME  TRLGKA   (S)           FORTRAN
C   20/03/81 309242036  MEMBER NAME  TRLGL    (S)           FORTRAN
...
C               10 MEV
C     LAST CHANGE MAR.18. 1981   E ELSEN
C     USE LHO APPROXIMATION FOR HADRONS IN LEADGLASSS
C     ===> CHANGED :  USE THE SIMULATION BY THE RESULTS OF KEK TEST EXP.
C
C   REMOVED THE BLOCK DATA SETTING OF /CFLAG/
