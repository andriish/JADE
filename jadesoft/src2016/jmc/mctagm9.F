C   23/08/85 711182013  MEMBER NAME  MCTAGM   (S)           FORTRAN
...
C A.J.FINCH 13/3/84
C
C ERRORS CORRECTED  18.11.1987    J.O.
C
C
...
C    THMINP - +Z
C
C THE INNER LIMIT IS CALCULATED FROM 96MM AT DISTANCE 2950+350 MM
C
C     DATA THMINM/0.0335,0.0361,0.0410,7*0.0320/
      DATA THMINM/0.0335,0.0361,0.0410,7*0.0290/
C     DATA THMINP/0.0335,0.0361,0.041,7*0.0320/
      DATA THMINP/0.0335,0.0361,0.041,7*0.0290/
...
C
      ICALT = ICALT + 1
      IF(ICALT.EQ.1) WRITE(6,9430)
9430  FORMAT(' TAGGING MC CORRECTED 18.11.1987....')
C
...
C
C SIMPLE MINDED TREATMENT OF SHOWERS LEAVING BACK OF DETECTOR
C
