C   25/08/83 606101308  MEMBER NAME  JRING9   (S)           FORTRAN
C
C-----------------------------------------------------------------------
      SUBROUTINE JRING( IRING, ICELL, COSAL, SINAL,
     *                  X, P, IRETRN , DRMAX, * )
C-----------------------------------------------------------------------
C
...
C
C       MOD C. BOWDERY   18/08/81 : NEW CODE FOR 4V/JETC ASSOCIATION
C
...
C
  1   IPOS = 0
      CALL JRCHCK( X, P, IRING, IPOS, IRETRN, *2000, COSAL,SINAL, DRMAX)
      IRETRN = 4
      SINSUS = SINAL
      COSSUS = COSAL
C
...
C
         CALL JRCHCK( X, P, IRING, IPOS, IRETRN,
     *                *2000, COSSUS, SINSUS, DRMAX)
C
C
