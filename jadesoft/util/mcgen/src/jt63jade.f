...
********************************************************************************
*.
*.  Default parameter set for Jetset 6.3 used in previous JADE analyses.
*.
...
********************************************************************************
      ...
      SAVE /LUDAT1/
      INTEGER KTYP63,KFR63
      REAL PMAS63,PWID63,CFR63
      COMMON/LUDAT2/KTYP63(120),PMAS63(120),PWID63(60),KFR63(80)
     >     ,CFR63(40)
      SAVE /LUDAT2/
      INTEGER IDB63,KDP63
      REAL DPAR63,CBR63
      ...
      SAVE /LUDAT3/
      CHARACTER CHAG63*4,CHAF63*4
      COMMON/LUDAT4/CHAG63(50),CHAF63(100)
      SAVE /LUDAT4/
      INTEGER MSTE63
      REAL PARE63
...
C SET PARAMETER FOR PETERSON FRAGMENTATION FUNCTION
      PAR63(44)= -0.05
      PAR63(45)= -0.01
C SET WIDHT OF TRANSVERSAL MOMENTUM DRISTIBUTION
      PAR63(12)=  0.300
*
*  Dalitz decay 
*
C PI0 SET KDP(369) FROM 1 TO 2001
C ETA SET KDP(389) FROM 1 TO 2001
      KDP63(369)= 2001
      KDP63(389)= 2001
*
*  QCD matrix element / parton shower
*
C SET QCD-TYPE: 1=1ST O. QCD/ 2= 2ND O. QCD/ 3= PARTON SHOWER
      MSTE63(1)= 3
C SET BRANCHING MODE: 0 NO AT ALL   1 CONV. BRANCHING  2: COHERENT
      MSTE63(11)= 2
C SET PERT. QCD LAMBDA VALUES:
      PARE63(1)=  1.500
      PARE63(2)=  0.500
C SET LEADING LOG LAMBDA:
      PARE63(21)= 0.400
C SET SHOWER MASS CUTOFF / YMIN
      PARE63(22)= 1.0
      PARE63(8)= 0.015
*
*  Misc
*
C SET NUMBER OF ALLOWED FLAVOURS:
      MSTE63(4)= 5
C SET RADIATIVE CORR.: 0 NONE   1: B-K
      MSTE63(7)= 0
C SET MST(8) = 1 FOR DECAY WIDTH CORRECT
      MST63(8)= 1
C SET STATISTICS: 0: NO  1: PARTONS   2: ALSO FINAL STATE
      MSTE63(31)= 2
C WRITE OUT SOME IMPORTANT PARAMETERS:
      WRITE(6,900) MSTE63(1),MSTE63(11),MSTE63(7),MSTE63(4),
     &     PARE63(1),PARE63(2),PARE63(21),PARE63(22),PARE63(8),
     &     MST63(4),PAR63(31),PAR63(32),PAR63(44),PAR63(45),PAR63(12)
 900  FORMAT( ' >QCD-TYPE               ...',I10,/,
     &' >BRANCHING MODE         ...',I10,/,
     &' >RAD. CORRECTION        ...',I10,/,
     &' >NUMBER OF FLAVOURS     ...',I10,/,
     &' >PERT QCD LAMBDAS       ...',2F10.3,/,
     &' >LLA LAMBDA             ...',F10.3,/,
     &' >SHOWER MASS CUT        ...',F10.3,/,
     &' >YMIN                   ...',F10.3,/,
     &' >FF-TYPE                ...',I10,/,
     &' >LUND FF       A,B      ...',2F10.3,/,
     &' >PETERSON FF   C(c),C(b)...',2F10.3,/,
     &' >SIGMA                  ...',F10.3)
      RETURN
      END
C  JADEEV 15.15.00: Code to write out MC records in /CPROD/ format. P.A.Movilla FErnandez
*.
*. This patch contains write out routines for event records
*. both in the binary JADE 'CPROD' format and in an NTuple format.
*.
*. 15.05.00  Pedro Movilla Fernandez
*. 06.06.01  last mod
*.
CDECK  ID>, RLU74.
      FUNCTION RLU74(IDUMMY)
C...Taken from Jetset7.4 OPAL version (jt74opal.car) 
...
C...Update counters. Random number to output.
      ...
      END
C
C Jetset74 routines needed for a Jetset63 run using the MC105J package
CDECK  ID>, LU74KERN.
      FUNCTION LUCOMP(KF)
C
C     JETSET7.4 FUNCTION LUCOMP
C
...
* PMF30.05.2001      BLOCK DATA LUDATA
* change name to avoid conflict with jetset7.4
* add initialisation of /GUDATR/
      BLOCK DATA LUDA63
      COMMON/LUDAT1/MST(40),PAR(80)
      COMMON/LUDAT2/KTYP(120),PMAS(120),PWID(60),KFR(80),CFR(40)
      COMMON/LUDAT3/DPAR(20),IDB(120),CBR(400),KDP(1600)
...
C PMF06.06.01: add this initialization
...
C 01.06.01, PMF: USE JETSET7.4-LIKE RLU VERSION
      RLU=RLU74( IDUM )
C
      RETURN
      END
