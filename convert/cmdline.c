/*
  ...
  /usr/bin/gengetopt -N --input=/home/andriish/Projects/JADE/convert/cmdline.ggo --file-name cmdline --output-dir=/home/andriish/Projects/JADE/convert --include-getopt --show-required -u'inputfile outputfile' 
