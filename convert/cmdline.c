/*
  ...
  /usr/local/bin/gengetopt -N --input=/Volumes/Work/JADE/convert/cmdline.ggo --file-name cmdline --output-dir=/Volumes/Work/JADE/convert --include-getopt --show-required -u'inputfile outputfile' 
