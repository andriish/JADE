/*
  ...
  /usr/bin/gengetopt -N --input=/home/andriish/Projects/JADE/JADE/convert/cmdline.ggo --file-name cmdline --output-dir=/home/andriish/Projects/JADE/JADE/convert --include-getopt --show-required -u'inputfile outputfile' 
...
const char *cmdline_parser_input_format_values[] = {"hepmc2", "hepmc3", "hpe", "root", "treeroot", "lhef", "gz", "plugin", 0}; /*< Possible values for input-format. */
const char *cmdline_parser_output_format_values[] = {"hepmc2", "hepmc3", "hpe", "root", "treeroot", "treerootopal", "hpezeus", "dump", "dot", "jade", "plugin", 0}; /*< Possible values for output-format. */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->input_format_help = gengetopt_args_info_help[2] ;
  args_info->output_format_help = gengetopt_args_info_help[3] ;
  args_info->extensions_help = gengetopt_args_info_help[4] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:o:e:", long_options, &option_index);
