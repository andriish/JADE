...
{\bf In adiition  the Data Preservation  experince with JADE has an extreame importance on itself.}\\
...
Because of  previous efforts and high quality of code,  porting  was possible.
...
\begin{itemize}
\item event display;
\item Monte-Carlo standalone generation packages;
\end{itemize}
\end{itemize}
...
\frame{\frametitle{JADE software environment/VM}
\begin{figure}\centering
\includegraphics[width=0.85\textwidth]{eps/Screenshot_2.eps}
\end{figure}
Generic start of VM.
}
...
\includegraphics[width=0.85\textwidth]{eps/Screenshot_2.eps}
\end{figure}
MC for JADE can be generated in VM ol elsewhere. In this case SHERPA is running in VM.
}
